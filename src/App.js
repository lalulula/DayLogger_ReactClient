      ...
      {isLoggedIn&&
        <div className='pageHeader'>
          ...
          <div className='pageMenu'> 
            <span className={active[0]? "currentLink" : ""} onClick={handleLogDayClick}>Log Day</span>
            <span className={active[1]? "currentLink" : ""} onClick={handleEditQuestionsClick}>Edit Questions</span>
            <span className={active[2]? "currentLink" : ""} onClick={handleViewDataClick}>View Data </span>
          </div>
          <img className='profileImage' src={defaultpImg} onClick={handleProfilePageClick}/>
        </div>
      }
